...
function init() {
   ...
   function F(a) {
      ...
      function h(a) {
         ...
         document.removeEventListener(g ? "touchmove" : "mousemove", f, { passive: true }), document.removeEventListener(g ? "touchend" : "mouseup", h, { passive: true }), A.forEach(function(a) {
            a.takeoff()
         })
      }
      let b = g ? a.touches[0] : a,
      ...
      document.addEventListener(g ? "touchmove" : "mousemove", f, { passive: true }), document.addEventListener(g ? "touchend" : "mouseup", h, { passive: true })
   }
   ...
   function G(a, b, c, d, scrollbar) {
      ...
      function ba() {
         ...
         }, e.addEventListener("webkitAnimationEnd", e.normalEnd, { passive: true }), R(e, b.name, b.time), N.forEach(function(a) {
      ...
      function be(b) {
         u && (b ? S(u) : (u.style.opacity = "0", u.style.webkitTransition = "opacity 0.33s linear")), e.removeEventListener("webkitAnimationEnd", e.normalEnd, { passive: true }), delete e.earlyEnd, delete e.normalEnd
      }
   ...
   function onload() {
      document.addEventListener(g ? "touchstart" : "mousedown", F, { passive: true })
      E()
   }
